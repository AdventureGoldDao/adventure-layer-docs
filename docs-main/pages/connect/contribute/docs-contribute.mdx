---
title: Ways to Contribute to Adventure Layer Docs
lang: en-US
description: Learn about the different ways you can contribute to Adventure Layer Docs.
---

import { Callout } from 'nextra/components'

# Contribute to Adventure Layer Docs

Adventure Layer Docs (docs.optimism.io) is an open-source project, and we welcome your contributions. Here's how you can help grow and support the Adventure Layer Collective.
...
*   [Add a glossary term](https://github.com/ethereum-optimism/docs/issues/new?assignees=\&labels=glossary%2Cdocumentation%2Ccommunity-request\&projects=\&template=suggest_glossary_term.yaml\&title=Suggest+a+glossary+term):
    help us continue to expand the Adventure Layer [glossary](/connect/resources/glossary).
...
*   [Contribute to the Adventure Layer Collective](https://github.com/ethereum-optimism/ecosystem-contributions): select from several different categories where you can make an impact such as
...
*   the [Adventure Layer vision and values](https://www.optimism.io/about)
...
We want to transition to a more community-informed and community-generated approach for the Adventure Layer Docs, so please raise questions in issues, submit PRs, or contact the team:
