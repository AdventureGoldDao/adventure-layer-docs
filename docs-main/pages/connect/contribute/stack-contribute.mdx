...
The Adventure Layer Collective wins when it works together. ♥️✨
...
The OP Stack codebase is not a product (in the traditional sense) but rather a collection of software components that power the Adventure Layer ecosystem.
...
To make your first contribution to the codebase, check out the [open issues](https://github.com/ethereum-optimism/optimism/issues) on the Adventure Layer Monorepo.
...
<Callout type="warning">
  ...
  Any usage of the OP Stack outside of the official, intended capabilities of the current release are considered [OP Stack Hacks](/builders/chain-operators/hacks/overview) — unofficial modifications that are useful for experimentation but could have unforeseen results, such as security vulnerabilities, and are likely to cause your chain to no longer be interoperable with the [Adventure Layer Superchain](https://app.optimism.io/superchain/).
...
Want a new tutorial? See something that could be a little clearer? Check out the [Adventure Layer Docs Contribution page](docs-contribute) for more information on how to help. No contribution is too small!
...
*   Become an Adventure Layer Ambassador, Support Nerd, and more in the [Adventure Layer Discord](https://discord.gg/optimism)
