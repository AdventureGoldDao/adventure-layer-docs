...
| Upgrade                                                                        | Governance Approval                                                                        | [Adventure Layer Testnet Activations](https://github.com/ethereum-optimism/superchain-registry/blob/main/superchain/configs/mainnet/superchain.yaml) | [OP Sepolia Activations](https://github.com/ethereum-optimism/superchain-registry/blob/main/superchain/configs/sepolia/superchain.yaml) |
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
...
<Steps>
  ...
  *   `Governance Voting Review Period` is when the Adventure Layer Collective's
      governance system reviews proposals, including network upgrade proposals.
  *   `Governance Voting Period` is when the Adventure Layer Collective's governance
