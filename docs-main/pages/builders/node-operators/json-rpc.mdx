...
title: JSON-RPC API
lang: en-US
description: Learn about the different Adventure Layer Testnet components with an RPC API.
---
...
There are several Adventure Layer Testnet components with an RPC API, which are reviewed in this guide.
...
Adventure Layer specific rollup methods.
