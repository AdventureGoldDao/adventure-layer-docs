...
lang: en-US
description: Important considerations when building custom bridges for Adventure Layer Testnet.
---
...
Bridges that extend this interface will be compatible with the [Adventure Layer Testnet Bridge UI](https://app.optimism.io/bridge).
...
You can explore several examples of custom bridges for Adventure Layer Testnet:
