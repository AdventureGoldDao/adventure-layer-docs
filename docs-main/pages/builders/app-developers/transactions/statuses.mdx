---
title: Transaction Statuses on Adventure Layer Testnet
lang: en-US
description: Learn about the statuses transactions can have on Adventure Layer Testnet.
---

# Transaction Statuses on Adventure Layer Testnet

Transactions on Adventure Layer Testnet can have a number of different statuses depending on where a transaction is in the process of being included in the blockchain.
...
Once a block has been finalized it is guaranteed to be included in the Adventure Layer Testnet blockchain.
