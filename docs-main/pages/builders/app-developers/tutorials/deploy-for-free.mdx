...
<Steps>
  ...
  *   Click **Verify**, and proceed with proving ownership of the contract deployment.
  ...
  <Callout type="info">
    For this first iteration, the rebate will be claimed on Adventure Layer Testnet. In the future, it will be possible to claim rebates on any chain in the Superchain.
  </Callout>
