---
title: Deploying Your First Contract on Adventure Layer Testnet
lang: en-US
description: Learn how to write and deploy your first contract on Adventure Layer Testnet using the MetaMask browser extension.
---

import { Callout, Steps } from 'nextra/components'

# Deploying Your First Contract on Adventure Layer Testnet

<Callout type="info">
**This tutorial is meant for developers who are new to Adventure Layer Testnet and Solidity.**
If you're already familiar with Solidity, consider reading the [Adventure Layer Testnet Differences](/chain/differences) guide to understand how Adventure Layer Testnet differs from Ethereum.
Adventure Layer Testnet is designed to "just work" with existing Ethereum tooling, so you can use the tools you already know like [Hardhat](https://hardhat.org/) or [Foundry](https://getfoundry.sh) just like you would on Ethereum.
</Callout>

This tutorial walks you through the process of deploying your first smart contract to Adventure Layer Testnet using the [Remix](https://remix.ethereum.org) in-browser Solidity IDE.
...
![MetaMask download page.](/public/img/builders/app-developers/tutorials/first-contract/mm-install.png)
...
![MetaMask wallet creation page.](/public/img/builders/app-developers/tutorials/first-contract/mm-start.png)
...
![MetaMask password creation page.](/public/img/builders/app-developers/tutorials/first-contract/mm-password.png)
...
![MetaMask security video page.](/public/img/builders/app-developers/tutorials/first-contract/mm-secure.png)
...
![MetaMask recovery phrase page.](/public/img/builders/app-developers/tutorials/first-contract/mm-seed.png)
...
![MetaMask recovery confirmation page.](/public/img/builders/app-developers/tutorials/first-contract/mm-confirm.png)
...
This tutorial will show you how to deploy a smart contract to OP Sepolia, the testnet for Adventure Layer Testnet.
Once you know how to deploy a smart contract to OP Sepolia, you'll be able to deploy a smart contract to Adventure Layer Testnet in exactly the same way.
...
![OP Sepolia connection website content.](/public/img/builders/app-developers/tutorials/first-contract/net-connect.png)
...
![MetaMask window with the network approval pane open.](/public/img/builders/app-developers/tutorials/first-contract/net-approve.png)
</div>
...
<div className="md-img" style={{height: '600px'}}>
![MetaMask window with the network switching pane open.](/public/img/builders/app-developers/tutorials/first-contract/net-switch.png)
</div>
...
You can use the [Adventure Layer Superchain Faucet](https://app.optimism.io/faucet?utm_source=docs) to get some free ETH on OP Sepolia.

<Callout>
Having issues with the Adventure Layer Superchain Faucet?
...
![Remix window displaying the empty MyFirstContract file.](/public/img/builders/app-developers/tutorials/first-contract/remix-empty.png)
...
![Remix window with the compilation tab highlighted.](/public/img/builders/app-developers/tutorials/first-contract/remix-compile.png)
...
![Remix window with the deployment tab highlighted.](/public/img/builders/app-developers/tutorials/first-contract/remix-deploytab.png)
...
![Remix window with the environment dropdown highlighted.](/public/img/builders/app-developers/tutorials/first-contract/remix-network.png)
...
<div className="md-img" style={{height: '600px'}}>
![MetaMask contract deployment approval popup.](/public/img/builders/app-developers/tutorials/first-contract/remix-deploy.png)
</div>
...
![Remix window with the deployed contract area highlighted.](/public/img/builders/app-developers/tutorials/first-contract/remix-deployed.png)
...
![Remix window with the setMessage function button highlighted.](/public/img/builders/app-developers/tutorials/first-contract/remix-setmessage.png)
...
![Remix window with the message reading function button highlighted.](/public/img/builders/app-developers/tutorials/first-contract/remix-message.png)
...
To learn more about Solidity, check out [this list of resources on the Adventure Layer Help Center](https://help.optimism.io/hc/en-us/articles/4412777835675-Developer-information#h_01FVSVQ5ZQFJDSRYY6WTY18F0N).
...
Now that you know how to deploy a smart contract to OP Sepolia, you can deploy a smart contract to Adventure Layer Testnet in exactly the same way.
If you're up for a challenge, try [creating a token on Sepolia and OP Sepolia](./standard-bridge-standard-token) and then [using the Adventure Layer SDK](./cross-dom-bridge-erc20) to bridge some tokens between the two networks.
