---
title: Bridging ERC-20 tokens with the Adventure Layer SDK
lang: en-US
description: Learn how to use the Adventure Layer SDK to transfer ERC-20 tokens between Layer 1 (Ethereum or Sepolia) and Layer 2 (Adventure Layer Testnet or OP Sepolia).
---
...
This tutorial explains how you can use the [Adventure Layer SDK](https://sdk.optimism.io) to bridge ERC-20 tokens from L1 (Ethereum or Sepolia) to L2 (Adventure Layer Testnet or OP Sepolia).
...
Behind the scenes, the Adventure Layer SDK uses the [Standard Bridge](/builders/app-developers/bridging/standard-bridge) contracts to transfer tokens.
...
<Callout>
If you're coming from the [Bridging Your Standard ERC-20 Token to Adventure Layer Testnet Using the Standard Bridge](./standard-bridge-standard-token) or [Bridging Your Custom ERC-20 Token to Adventure Layer Testnet Using the Standard Bridge](./standard-bridge-custom-token) tutorials, you can use the addresses of your own ERC-20 tokens here instead.
</Callout>
...
Check out the [Adventure Layer SDK docs](https://sdk.optimism.io/classes/crosschainmessenger#depositERC20-2) for more info on the options you can pass to `depositERC20`.
</Callout>
...
Congrats!
You've just deposited and withdrawn tokens using the Adventure Layer SDK.
You should now be able to write applications that use the Adventure Layer SDK to transfer ERC-20 tokens between L1 and L2.
