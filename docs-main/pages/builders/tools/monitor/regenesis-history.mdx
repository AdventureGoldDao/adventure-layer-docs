...
<Steps>
  ### Browse to the [Adventure Layer Explorer](https://explorer.optimism.io/exportDataMain).
...
Since this was very early during the history of Adventure Layer Testnet there are relatively
