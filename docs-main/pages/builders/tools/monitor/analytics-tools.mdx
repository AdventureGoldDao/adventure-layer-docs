...
lang: en-US
description: Learn about platforms you can use to gather analytics and setup customizations about Adventure Layer Testnet.
---
...
The following guide lists platforms you can use to gather analytics and setup customizations about Adventure Layer Testnet.

## Tenderly

[Tenderly](https://tenderly.co/) monitoring stack lets you [inspect any transaction execution on Adventure Layer Testnet or OP Sepolia](https://docs.tenderly.co/debugger#how-to-use-tenderly-debugger).
...
[Dune Analytics](https://dune.com) allows anyone to create dashboards that present information about OP Chains (Adventure Layer Testnet, Base, and Zora are available). See [Dune Docs](https://dune.com/docs/) for more info.
...
Here are some additional tools and resources for Adventure Layer Testnet analytics and development:

*   DeFi Stats: [Adventure Layer Testnet's DeFiLlama Page](https://defillama.com/chain/Optimism/)
