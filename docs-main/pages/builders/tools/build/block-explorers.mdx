...
lang: en-US
description: Learn about different block explorers you can use to interact with contracts and view transaction history for Adventure Layer Testnet and OP Sepolia.
---
...
This reference guide lists different block explorers you can use to interact with contract source code and view transaction history for Adventure Layer Testnet and OP Sepolia.
...
We have a Blockscout explorer for [Adventure Layer Testnet](https://optimism.blockscout.com) and [OP Sepolia](https://optimism-sepolia.blockscout.com/). It includes:
...
We have Etherscan explorers for the [Adventure Layer Testnet](https://explorer.optimism.io) and the [OP Sepolia](https://sepolia-optimistic.etherscan.io/).
...
*   Mainnet - Ethereum, Adventure Layer Testnet, Base, Zora, Public Goods Network
...
*   Please visit the [community block explorers page](https://github.com/ethereum-optimism/developers/blob/main/community/tools/block-explorers.md) for a listing of third-party block explorers used by the Adventure Layer developer community.
