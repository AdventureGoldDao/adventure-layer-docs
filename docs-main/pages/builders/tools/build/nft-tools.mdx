---
title: Adventure Layer Testnet NFT Tools
lang: en-US
description: Learn the basics of creating an NFT on Adventure Layer Testnet.
---

import { Callout } from 'nextra/components'

# Adventure Layer Testnet NFT Tools

## The Adventure Layer Testnet NFT ecosystem

![The Adventure Layer Testnet NFT ecosystem page.](/img/guides/app-developers/OP-NFT-Ecosystem.jpg)

## Statistics

[Click here for statistics about NFTs on Adventure Layer Testnet](https://dune.com/oplabspbc/optimism-nft-secondary-marketplaces)

## Creator tools

These tools are available on Adventure Layer Testnet:
