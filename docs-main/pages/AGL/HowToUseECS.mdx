...
To create a demo project, you typically use a command-line tool or script. In your setup, it seems like you might use a tool like `mud` to initialize a project. This is not explicitly shown in the code snippets, but it would typically involve a command like:

```bash
mud init demo-project
```
