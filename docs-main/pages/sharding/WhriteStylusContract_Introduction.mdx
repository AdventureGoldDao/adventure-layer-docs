...
![Stylus gives you EVM+](https://docs.arbitrum.io/assets/images/stylus-gives-you-evm-plus-2a9fd8d83d3b68d67ec94ca8f418220f.png)
...
For a detailed overview of Nitro's technical architecture, see the [documentation](https://docs.arbitrum.io/how-arbitrum-works/inside-arbitrum-nitro) or the [Nitro whitepaper](https://github.com/OffchainLabs/nitro/blob/master/docs/Nitro-whitepaper.pdf).
