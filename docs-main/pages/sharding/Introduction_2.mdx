...
To facilitate seamless interaction with these nodes, The Adventure Layer uses URL routing. Suppose our node domain is `rpc.adventure.dev`. The nodes can be accessed through the following URLs:
