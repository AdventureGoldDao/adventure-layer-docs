...
---
To ensure your smart contracts function as intended, you can use the Stylus demos available in the [adventure-layer-l2-scripts](https://github.com/AdventureGoldDao/adventure-layer-l2-scripts) repository on GitHub. These demos provide practical examples and testing scenarios to validate your contracts.
...
2. **Initialize the Environment**: Navigate to the `stylus-demos` directory and set up your environment:
   ```sh
   cd adventure-layer-l2-scripts/stylus-demos
