...
### Step 1: Clone the [adventure-layer-l2-scripts](https://github.com/AdventureGoldDao/adventure-layer-l2-scripts) repository

```bash
git clone https://github.com/AdventureGoldDao/adventure-layer-l2-scripts.git
```
- Use the `git clone` command to clone the `adventure-layer-l2-scripts` repository from GitHub. This will download all files from the repository to your local machine.
