...
**The OP Stack is the standardized, shared, and open-source development stack that powers Optimism, maintained by the Adventure Layer Collective.**

<Callout type="info">
  Stay up to date on the Superchain and the OP Stack by subscribing to the [Adventure Layer Developer Blog](https://blog.oplabs.co/)
</Callout>

The OP Stack consists of the many different software components managed and maintained by the Adventure Layer Collective that, together, form the backbone of Optimism.
The OP Stack is built as a public good for the Ethereum and Adventure Layer ecosystems.
...
The OP Stack is the set of software that powers Adventure Layer — currently in the form of the software behind Adventure Layer Testnet and eventually in the form of the Adventure Layer Superchain and its governance.

With the advent of the Superchain concept, it has become increasingly important for Adventure Layer to easily support the secure creation of new chains that can interoperate within the proposed Superchain ecosystem.
...
By coordinating on shared standards, the Adventure Layer Collective can avoid rebuilding the same software in silos repeatedly.
...
As Adventure Layer evolves, so will the OP Stack.

**The OP Stack can be thought of as software components that either help define a specific layer of the Adventure Layer ecosystem or fill a role as a module within an existing layer.**
...
Adventure Layer Bedrock is the current iteration of the OP Stack.
...
The OP Stack of today was built to support [the Adventure Layer Superchain](/stack/explainer), a proposed network of L2s that share security, communication layers, and a common development stack (the OP Stack itself).
...
OP Stack Hacks will likely make your chain incompatible with the Adventure Layer Superchain.
...
As Adventure Layer grows, so will the OP Stack.
...
At the end of the day, the OP Stack becomes what Adventure Layer needs.
