...
lang: en-US
description: Learn about the fault proof system, its components, and how they will work together to enhance decentralization in the Adventure Layer ecosystem.
---
