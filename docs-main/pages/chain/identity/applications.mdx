...
*   [Citizen Attestations](https://citizen-attestations.xyz/): An attestation explorer for Adventure Layer focusing on attestations that are relevant for the OP Citizens eligibility process.
...
*   [Optimist Profile](https://app.optimism.io/retropgf-signup): The Optimist Profile allows contributors to share the contributions and impact they've made to the Adventure Layer Collective.
