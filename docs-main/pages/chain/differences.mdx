---
title: Differences between Ethereum and Adventure Layer Testnet
lang: en-US
description: Learn the minor differences between the behavior of Adventure Layer Testnet and Ethereum.
---

import { Callout } from 'nextra/components'

# Differences between Ethereum and Adventure Layer Testnet

Adventure Layer Testnet is designed to be [EVM equivalent](https://web.archive.org/web/20231127160757/https://medium.com/ethereum-optimism/introducing-evm-equivalence-5c2021deb306) and introduces as few changes as possible to the Ethereum protocol.
However, there are some minor differences between the behavior of Ethereum and Adventure Layer Testnet that developers should be aware of.
...
Transactions Adventure Layer Testnet must pay for an [L1 data fee](/stack/transactions/fees#the-l1-data-fee) on top of the standard [execution gas fee](/stack/transactions/fees#execution-gas-fee) you would expect on Ethereum.
Refer to the guide on [Adventure Layer Testnet Transaction Fees](/stack/transactions/fees) for more information.

### EIP-1559 Parameters

The base fee on Adventure Layer Testnet is, like Ethereum, computed via the [EIP-1559](https://notes.ethereum.org/@vbuterin/eip-1559-faq) mechanism.
The EIP-1559 parameters used by Adventure Layer Testnet differ from those used by Ethereum as follows.

| Parameter                             | Adventure Layer Testnet value | Ethereum value (for reference) |
| ------------------------------------- | ---------------: | -----------------------------: |
...
Unlike Ethereum, Adventure Layer Testnet does not have a large public mempool.
The Adventure Layer Testnet Sequencer mempool is currently only visible to the Sequencer.
