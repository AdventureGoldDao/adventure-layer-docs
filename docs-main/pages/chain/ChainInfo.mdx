...
title: Chain Info
---
# Mainnet Information Overview

- **Chain ID**: 9988
- **Explorer**: 

                [https://advlayer-mainnet.blockscout.com](https://advlayer-mainnet.blockscout.com)

                [https://advlayer-mainnet.cloud.blockscout.com](https://advlayer-mainnet.cloud.blockscout.com)

- **Bridge**:   [https://bridge-mainnet.adventurelayer.xyz](https://bridge-mainnet.adventurelayer.xyz)
- **RPC**:      [https://rpc.adventurelayer.xyz](https://rpc.adventurelayer.xyz)

# Devnet Chain Node Information Overview
