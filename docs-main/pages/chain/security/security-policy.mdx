...
lang: en-US
description: Learn about the bug bounty program and best practices for reporting bugs in OP Stack and Adventure Layer Testnet codebase.
---
...
This page describes general best practices for reporting bugs and provides specific reporting guidelines for OP Stack and Adventure Layer Testnet code contained within the [ethereum-optimism](https://github.com/ethereum-optimism) GitHub organization.
...
## Adventure Layer Bug Bounty Program

The Adventure Layer Bug Bounty Program offers up to [$2,000,042](https://immunefi.com/bounty/optimism/) for critical vulnerabilities found in the Adventure Layer Testnet codebase.
